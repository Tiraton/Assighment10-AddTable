  ...
  <div class="jumbotron">
    ...
    <form name="myForm" onsubmit="return validateForm()" action="create_expense.php" method="post">
      ...
      <div class="form-group">
        ...
        <textarea name="shipping" id="id_shipping_address" class="form-control" rows="3"></textarea>
        <span class="hint" id="shippinp_feedback"></span>
        <br>
      ...
      <h6 class="p-3 mb-4 mt-4 bg-primary text-white">2. Item Details</h6>
